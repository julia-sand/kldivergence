...
For Gaussian case: Fig. 3 and 5, see kl_underdamped_gauss (using Julia v1.7.3 and DifferentialEquations.jl v7.7.0)

For the overdamped solution of the cell problem, see OVERDAMPED_KL

For the computation of corrections to underdamped solutions, see underdamped_kl : Figs 6-8 of [2403.00679](https://arxiv.org/pdf/2403.00679). Additionally, results shown in Figs 2 and 4 of [2411.08518](https://arxiv.org/pdf/2411.08518) can also be found here, under 
...
For results shown in Figs 1 and 3, see the notebook mcintegration_entropy

For results shown in Fig 5, see the notebook mcintegration_neural
